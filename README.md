...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/flask-seasurf-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/flask-seasurf-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add flask-seasurf
# for installing globally
pixi global install flask-seasurf
```
...
It is possible to list all of the versions of `flask-seasurf` available on your platform:
...
```
pixi search flask-seasurf --channel conda-forge
```
